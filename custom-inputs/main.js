...
/***/ "./src/components/global/global-element.ts":
/*!*************************************************!*\
  !*** ./src/components/global/global-element.ts ***!
  \*************************************************/
/*! exports provided: GlobalElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GlobalElement", function() { return GlobalElement; });
/* harmony import */ var lit_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit-element */ "./node_modules/lit-element/lit-element.js");
/* harmony import */ var _impl_Controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../impl/Controller */ "./src/impl/Controller.ts");
/* harmony import */ var _impl_ListenerHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../impl/ListenerHandler */ "./src/impl/ListenerHandler.ts");
...
class GlobalElement extends lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"] {
  constructor() {
    super(...arguments);
    this.controller = _impl_Controller__WEBPACK_IMPORTED_MODULE_1__["Controller"].getInstance();
    this.listenerHandler = new _impl_ListenerHandler__WEBPACK_IMPORTED_MODULE_2__["ListenerHandler"]();
  }
  ...
  updated(changedProperties) {
    ...
    if (changedProperties.has('controller') && this.isConnected) {
      this.listenerHandler.clear();
...
__decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["property"])({
  type: Object
})], GlobalElement.prototype, "controller", void 0);

/***/ }),

/***/ "./src/components/my-card.scss":
/*!*************************************!*\
  !*** ./src/components/my-card.scss ***!
  \*************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lit_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit-element */ "./node_modules/lit-element/lit-element.js");
 /* harmony default export */ __webpack_exports__["default"] = (lit_element__WEBPACK_IMPORTED_MODULE_0__["css"]`div{padding:1em;width:50%;border:solid 1px #ccc;margin:1em auto}`);
    

/***/ }),

/***/ "./src/components/my-card.ts":
/*!***********************************!*\
  !*** ./src/components/my-card.ts ***!
  \***********************************/
...
/* harmony import */ var lit_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit-element */ "./node_modules/lit-element/lit-element.js");
/* harmony import */ var _my_card_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my-card.scss */ "./src/components/my-card.scss");
/* harmony import */ var _global_global_element__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./global/global-element */ "./src/components/global/global-element.ts");
/* harmony import */ var _my_counter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./my-counter */ "./src/components/my-counter.ts");
...
let MyCard = class MyCard extends _global_global_element__WEBPACK_IMPORTED_MODULE_2__["GlobalElement"] {
  render() {
    return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject());
  }

};
MyCard.styles = _my_card_scss__WEBPACK_IMPORTED_MODULE_1__["default"];
MyCard = __decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])('my-card')], MyCard);


/***/ }),

/***/ "./src/components/my-counter.scss":
/*!****************************************!*\
  !*** ./src/components/my-counter.scss ***!
  \****************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lit_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit-element */ "./node_modules/lit-element/lit-element.js");
 /* harmony default export */ __webpack_exports__["default"] = (lit_element__WEBPACK_IMPORTED_MODULE_0__["css"]`button{padding:1em 2em}`);
...
/*!**************************************!*\
  !*** ./src/components/my-counter.ts ***!
  \**************************************/
/*! exports provided: MyCounter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyCounter", function() { return MyCounter; });
/* harmony import */ var lit_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit-element */ "./node_modules/lit-element/lit-element.js");
/* harmony import */ var _my_counter_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my-counter.scss */ "./src/components/my-counter.scss");
/* harmony import */ var _global_global_element__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./global/global-element */ "./src/components/global/global-element.ts");
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <button @click=", ">+</button>\n      <button @click=", ">-</button>\n    "]);
...
let MyCounter = class MyCounter extends _global_global_element__WEBPACK_IMPORTED_MODULE_2__["GlobalElement"] {
  _handleIncrement() {
    this.controller.setCount(this.controller.count + 1);
  }

  _handleDecrement() {
    const newCount = Math.max(this.controller.count - 1, 0);
    this.controller.setCount(newCount);
  }

  render() {
    return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject(), this._handleIncrement, this._handleDecrement);
  }

};
MyCounter.styles = _my_counter_scss__WEBPACK_IMPORTED_MODULE_1__["default"];
MyCounter = __decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])('my-counter')], MyCounter);


/***/ }),

/***/ "./src/impl/Controller.ts":
/*!********************************!*\
  !*** ./src/impl/Controller.ts ***!
  \********************************/
...
/* harmony import */ var _Listener__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Listener */ "./src/impl/Listener.ts");
/* harmony import */ var _Disposable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Disposable */ "./src/impl/Disposable.ts");
/* harmony import */ var _ListenerHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ListenerHandler */ "./src/impl/ListenerHandler.ts");
...
class Controller extends _Disposable__WEBPACK_IMPORTED_MODULE_1__["Disposable"] {
  constructor() {
    super();
    this._listenerHandler = new _ListenerHandler__WEBPACK_IMPORTED_MODULE_2__["ListenerHandler"]();
    this.count = 0;
    this.onCountListener = new _Listener__WEBPACK_IMPORTED_MODULE_0__["Listener"]();
  }
  ...
  disposeInternal() {
    ...
    this._listenerHandler.dispose();
  }

  setCount(count) {
    this.count = count;
    this.onCountListener.emit(count);
  }
...
class Disposable {
  constructor() {
    ...
    this.onDispose = new _Listener__WEBPACK_IMPORTED_MODULE_0__["Listener"]();
  }
...
/***/ "./src/impl/ListenerHandler.ts":
/*!*************************************!*\
  !*** ./src/impl/ListenerHandler.ts ***!
  \*************************************/
/*! exports provided: ListenerHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ListenerHandler", function() { return ListenerHandler; });
/* harmony import */ var _Disposable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Disposable */ "./src/impl/Disposable.ts");

class ListenerHandler extends _Disposable__WEBPACK_IMPORTED_MODULE_0__["Disposable"] {
  constructor() {
    super(...arguments);
    this._map = [];
  }
  ...
  _removeHandler(handler) {
    const entry = this._getHandler(handler);

    if (entry === undefined) {
      return;
    }

    const index = this._map.indexOf(entry);
  ...
  add(handler, listener) {
    let entry = this._getHandler(handler);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _my_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my-app */ "./src/my-app.ts");
...
/* harmony import */ var lit_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit-element */ "./node_modules/lit-element/lit-element.js");
/* harmony import */ var _my_app_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./my-app.scss */ "./src/my-app.scss");
...
let App = class App extends _components_global_global_element__WEBPACK_IMPORTED_MODULE_2__["GlobalElement"] {
  constructor() {
    super(...arguments);
    this.count = 0;
  }
  ...
  addListeners() {
    this._addOnCountListener();
  }

  _addOnCountListener() {
    this.count = this.controller.count;
    this.listenerHandler.add(this.controller.onCountListener, count => {
      this.count = count;
    });
  }
...
App.styles = _my_app_scss__WEBPACK_IMPORTED_MODULE_1__["default"];

__decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["property"])({
  type: Number
})], App.prototype, "count", void 0);

App = __decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])('wizkids-element')], App);
